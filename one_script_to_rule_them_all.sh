...
echo "touch /home/jline/t1b.txt" | at 05:40
echo "echo \"# TILES1B PI #\" >> /home/jline/t1b.txt" |at 05:41
echo "echo \" \" >> /home/jline/t1b.txt" |at 05:42
echo "echo \"[05:30AM]: Sourced one_script_to_rule_them_all.sh \" >> /home/jline/t1b.txt" |at 05:43
...
echo "scp /home/jline/t1b.txt achokshi@ozstar.swin.edu.au:/fred/oz048/achokshi/mwa_sats/data/status" | at 06:23

# Clean up and get ready for next day
echo "rm /home/jline/t1b.txt" | at 06:25
